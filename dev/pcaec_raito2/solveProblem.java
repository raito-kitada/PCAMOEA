...
public class solveProblem {
	...
	public void opt(String aName, String pName, int trial, TypedProperties prop,String nelem) {
		/**
		 *  Set output path
		 */
        String outputPath = prop.getString("output_base_path", "./") + "/"  + pName + "/" +"nelem1000-p100-NFE10000-v1000"+"/object3/" + aName + "/"+ trial + "/";
