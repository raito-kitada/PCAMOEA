...
public class Plot {
	 ...
	 * @return a reference to this {@code Plot} instance
	 */
	public Plot add(String label, Solution[] solutions) {
		Solution solution = solutions[0];

		if (solution.getNumberOfObjectives() == 1) {
			return add(label, solutions, 0, 0);
		} else {
			return add(label, solutions, 0, 1);
		}
	}
	 ...
	 * @return a reference to this {@code Plot} instance
	 */
	public Plot add(String label, Solution[] solutions, int x, int y) {
