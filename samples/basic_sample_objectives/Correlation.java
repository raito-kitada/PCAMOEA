...
//			arrays.add((ArrayList<Double>) itemsXi);
//			arrays.add((ArrayList<Double>) itemsYi);
//			correlation_library(arrays);
...
//		}
		...
		public static void correlation_library(ArrayList<ArrayList<Double>> items) {
